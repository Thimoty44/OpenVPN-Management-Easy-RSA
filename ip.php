						...
						<div id="ipp"
							<?php
								...
								while ($ippdata = fgets($ipp, 1000) ) {
									...
									/* Condition who check if ipv6 used (show raw ip if ipv6 */
									if ($ipv6 == "false") {
										/* We shot the waiting result for show ipv4 */
										echo "<p>".$output_split[1]." ".$output_ip[1]."".$numbersipfinal."</p>";
									} else {
										/* Ip in ipv6 */
										echo "<p>".$output_split[1]." ".$output_split[2]."</p>";
									}
								}
							?>
							<br>
