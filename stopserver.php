				...
				<section>
					<div id=serverbutton>
							<form method="post" action="startserver.php">
   							...
   							<?php
   							/* Execute the command to stop server */
							$output = shell_exec('sudo systemctl stop '.$serviceopenvpn.'');
							?>
   						</div>
					<article>
						<div id=status>
							<p><strong>State of the server :</strong>
								<?php
									/* Execute the commande who return the status of the server and show it */
